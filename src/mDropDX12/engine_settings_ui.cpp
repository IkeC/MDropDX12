...
void SettingsWindow::DoBuildControls() {
  ...
  {
    HWND hMsgModeCombo = CreateWindowExW(WS_EX_CLIENTEDGE, L"COMBOBOX", NULL,
      ...
      GetModuleHandle(NULL), NULL);
    if (hMsgModeCombo && hFont) SendMessage(hMsgModeCombo, WM_SETFONT, (WPARAM)hFont, TRUE);
  ...
  y += lineH;
  {
    HWND hAudioCombo = CreateWindowExW(WS_EX_CLIENTEDGE, L"COMBOBOX", NULL,
    ...
    if (hAudioCombo && hFont) SendMessage(hAudioCombo, WM_SETFONT, (WPARAM)hFont, TRUE);
...

  {
    ...
    HWND hIdleActionCombo = CreateWindowExW(0, L"COMBOBOX", NULL,
      WS_CHILD | WS_TABSTOP | CBS_DROPDOWNLIST | CBS_HASSTRINGS,
      actionX + lblW, y, comboW, lineH * 6, hw,
      (HMENU)(INT_PTR)IDC_MW_IDLE_ACTION, GetModuleHandle(NULL), NULL);
    if (hIdleActionCombo && hFont) SendMessage(hIdleActionCombo, WM_SETFONT, (WPARAM)hFont, TRUE);
  ...
  y += lineH + 2;
  {
    ...
    HWND hFallbackCombo = CreateWindowExW(WS_EX_CLIENTEDGE, L"COMBOBOX", NULL,
      WS_CHILD | WS_TABSTOP | CBS_DROPDOWNLIST | CBS_HASSTRINGS,
      x, y, comboW, lineH + 8 * lineH, hw,
      (HMENU)(INT_PTR)IDC_MW_FALLBACK_TEX, GetModuleHandle(NULL), NULL);
    if (hFallbackCombo && hFont) SendMessage(hFallbackCombo, WM_SETFONT, (WPARAM)hFont, TRUE);
