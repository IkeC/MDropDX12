...
void Engine::LaunchMessage(wchar_t* sMessage) {
  ...
  else if (MSG_IS(sMessage, L"PRESET=")) {
  ...
  else if (MSG_IS(sMessage, L"WAVE|")) {
    std::wstring message(sMessage + 5);
    SetWaveParamsFromMessage(message);
  }
  else if (MSG_IS(sMessage, L"DEVICE=")) {
  ...
  else if (MSG_IS(sMessage, L"RELOAD_ANNOTATIONS")) {
  ...
  else if (MSG_IS(sMessage, L"VFX_SCOPED_KEEP=")) {
  ...
  else if (MSG_IS(sMessage, L"VFX_SCOPED_STATUS")) {
    extern PipeServer g_pipeServer;
  ...
  else if (MSG_IS(sMessage, L"PRESET_OVERRIDE_STATUS")) {
  ...
  else if (MSG_IS(sMessage, L"SHADER_OVERRIDE_STATUS")) {
  ...
  else if (MSG_IS(sMessage, L"SHADER_OVERRIDE_RELOAD")) {
  ...
  else if (MSG_IS(sMessage, L"SHADER_OVERRIDE_REVERT")) {
    extern PipeServer g_pipeServer;
    RevertOverrideOnCurrentPreset();
    g_pipeServer.Send(L"SHADER_OVERRIDE_APPLIED=");
  }
  else if (MSG_IS(sMessage, L"SHADER_OVERRIDE_ENABLE=")) {
    extern PipeServer g_pipeServer;
  ...
  else if (MSG_IS(sMessage, L"SHADER_OVERRIDE_APPLY=")) {
    extern PipeServer g_pipeServer;
  ...
  else if (MSG_IS(sMessage, L"SET_PRESET_NOTE=")) {
  ...
  else if (MSG_IS(sMessage, L"GET_PRESET_NOTE")) {
  ...
  else if (MSG_IS(sMessage, L"SET_PRESET_RATING=")) {
  ...
  else if (MSG_IS(sMessage, L"GET_PRESET_RATING")) {
  ...
  else if (MSG_IS(sMessage, L"GET_PRESET_HASH")) {
  ...
  else if (MSG_IS(sMessage, L"GET_PRESET_STATUS")) {
  ...
  else if (MSG_IS(sMessage, L"LINK=")) {
    std::wstring message(sMessage + 5);
    m_RemotePresetLink = std::stoi(message);
  }
  else if (MSG_IS(sMessage, L"QUICKSAVE")) {
    g_engine.SaveCurrentPresetToQuicksave(false);
  }
  else if (MSG_IS(sMessage, L"CONFIG_EXPORT_INI")) {
  ...
  else if (MSG_IS(sMessage, L"CONFIG")) {
    ReadConfig();
    // to update fonts — use ResetBufferAndFonts for proper SRV cleanup
    ResetBufferAndFonts();
  }
  else if (MSG_IS(sMessage, L"SETTINGS")) {
  ...
  else if (MSG_IS(sMessage, L"TESTFONTS")) {
  ...
  else if (MSG_IS(sMessage, L"TRACK|")) {
  ...
  else if (MSG_IS(sMessage, L"SPOUTINPUT=")) {
  ...
  else if (MSG_IS(sMessage, L"CAPTURE")) {
  ...
  else if (MSG_IS(sMessage, L"FFT_ATTACK=")) {
  ...
  else if (MSG_IS(sMessage, L"CLEAR_LIST")) {
  ...
  else if (MSG_IS(sMessage, L"ENUM_LISTS")) {
  ...
  else if (MSG_IS(sMessage, L"SET_DIR=")) {
  ...
  else if (MSG_IS(sMessage, L"SHADER_IMPORT=")) {
  ...
  else if (MSG_IS(sMessage, L"SHADER_GLSL=")) {
  ...
  else if (MSG_IS(sMessage, L"SHADER_CONVERT=")) {
  ...
  else if (MSG_IS(sMessage, L"SHADER_SAVE=")) {
  ...
  else if (MSG_IS(sMessage, L"SET_LOGLEVEL=")) {
  ...
  else if (MSG_IS(sMessage, L"SET_VFX=")) {
  ...
  else if (MSG_IS(sMessage, L"GET_VFX_STATUS")) {
  ...
  else if (MSG_IS(sMessage, L"GET_VFX")) {
  ...
  else if (MSG_IS(sMessage, L"VFX_RESET=")) {
  ...
  else if (MSG_IS(sMessage, L"VFX_PROFILE_LIST")) {
  ...
  else if (MSG_IS(sMessage, L"DIAG_CONFIG")) {
  ...
  else if (MSG_IS(sMessage, L"DIAG_AUDIO")) {
  ...
  else if (MSG_IS(sMessage, L"DIAG_SIMULATE_DEVICE_REMOVED")) {
  ...
  else if (MSG_IS(sMessage, L"AUDIO_PROFILE_CLEAR")) {
  ...
  else if (MSG_IS(sMessage, L"AUDIO_PROFILE=")) {
    SetPresetAudioProfile(m_szCurrentPresetFile, sMessage + 14, true);
    ResolveAudioProfileForPreset(m_pState);
  }
  else if (MSG_IS(sMessage, L"AUDIO_PROFILE_LIST")) {
  ...
  else if (MSG_IS(sMessage, L"VFX_PROFILE_IMPORT=")) {
  ...
  else if (MSG_IS(sMessage, L"TESTING_MODE")) {
  ...
  else if (MSG_IS(sMessage, L"SET_IDLE_TIMER=")) {
  ...
  else if (MSG_IS(sMessage, L"GET_IDLE_TIMER")) {
  ...
  else if (MSG_IS(sMessage, L"DIAG_MIRRORS")) {
  ...
  else if (MSG_IS(sMessage, L"DIAG_BINDINGS")) {
    extern PipeServer g_pipeServer;
  ...
  else if (MSG_IS(sMessage, L"GET_FALLBACK_TEX")) {
    extern PipeServer g_pipeServer;
  ...
  else if (MSG_IS(sMessage, L"SET_FALLBACK_TEX=")) {
    extern PipeServer g_pipeServer;
  ...
  else if (MSG_IS(sMessage, L"SET_MIRROR_WIPE")) {
  ...
  else if (MSG_IS(sMessage, L"SET_MIRROR_OPACITY=")) {
  ...
  else if (MSG_IS(sMessage, L"SET_MIRROR_CLICKTHRU=")) {
  ...
  else if (MSG_IS(sMessage, L"SET_MIRROR_INDEPENDENT=")) {
  ...
  else if (MSG_IS(sMessage, L"SET_MIRROR_MAXFPS=")) {
  ...
  else if (MSG_IS(sMessage, L"SET_FPS=")) {
  ...
  else if (MSG_IS(sMessage, L"GET_FPS")) {
  ...
  else if (MSG_IS(sMessage, L"GET_MIRROR_MAXFPS")) {
  ...
  else if (MSG_IS(sMessage, L"SET_ALWAYS_ON_TOP=")) {
  ...
  else if (MSG_IS(sMessage, L"SET_MIRROR_ENABLED=")) {
  ...
  else if (MSG_IS(sMessage, L"MOVE_TO_DISPLAY=")) {
  ...
  else if (MSG_IS(sMessage, L"SET_WINDOW=")) {
  ...
  else if (MSG_IS(sMessage, L"GET_LOGLEVEL")) {
  ...
  else if (MSG_IS(sMessage, L"SHUTDOWN")) {
  ...
  else if (MSG_IS(sMessage, L"DIAG_DISPLAY_MODE=")) {
  ...
  else if (MSG_IS(sMessage, L"SET_AUDIO_GAIN=")) {
  ...
  else if (MSG_IS(sMessage, L"GET_AUDIO_GAIN")) {
    wchar_t buf[128];
    swprintf_s(buf, L"AUDIO_GAIN=%.2f|effective=%.2f", m_fAudioSensitivity, mdropdx12_audio_sensitivity);
    extern PipeServer g_pipeServer;
    g_pipeServer.Send(buf);
  }
  else if (MSG_IS(sMessage, L"SET_DEVICE_VOLUME=")) {
  ...
  else if (MSG_IS(sMessage, L"GET_DEVICE_VOLUME")) {
    float curVol = 0; BOOL muted = FALSE;
  ...
  else if (MSG_IS(sMessage, L"SET_DEVICE_MUTE=")) {
  ...
  else if (MSG_IS(sMessage, L"TOGGLE_DEVICE_MUTE")) {
    float curVol = 0; BOOL muted = FALSE;
    HRESULT hr = GetDeviceVolume(m_szAudioDevice, m_nAudioDeviceRequestType, &curVol, &muted);
    if (SUCCEEDED(hr))
  ...
  else if (MSG_IS(sMessage, L"GET_RENDER_DIAG")) {
  ...
  else if (MSG_IS(sMessage, L"TEST_EEL_ISOLATION")) {
  ...
  else if (MSG_IS(sMessage, L"GET_EEL_STATE")) {
  ...
  else if (MSG_IS(sMessage, L"GET_AUDIO_DIAG")) {
  ...
  else if (MSG_IS(sMessage, L"DEAUTH_DEVICE|")) {
  ...
  else if (MSG_IS(sMessage, L"TOGGLE_MESSAGES")) {
  ...
  else if (MSG_IS(sMessage, L"SET_MESSAGES=")) {
  ...
  else if (MSG_IS(sMessage, L"GET_MESSAGES")) {
    extern PipeServer g_pipeServer;
    wchar_t buf[64];
    swprintf_s(buf, L"MESSAGES=%d", MessagesEnabled() ? 1 : 0);
    g_pipeServer.Send(buf);
