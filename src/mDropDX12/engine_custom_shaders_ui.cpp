...
void CustomShadersWindow::DoBuildControls()
{
    ...
    HWND hList = CreateListBox(m_hWnd, IDC_MW_CSHADER_LIST, x, listY, rw, listH, m_hFont,
    ...
    HWND hRules = CreateListBox(m_hWnd, IDC_MW_CSHADER_RULES, x, ruleListY, rw, ruleH,
      m_hFont, WS_VSCROLL | LBS_NOINTEGRALHEIGHT);
    ...
    HWND hVfx = CreateCombo(m_hWnd, IDC_MW_CSHADER_RULEVFX, x + lblW + btnGap, vfxRowY,
      rw - lblW - btnGap, lineH * 8, m_hFont, WS_VSCROLL | CBS_DROPDOWNLIST);
