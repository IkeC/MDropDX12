...
#define IDC_MW_DISP_MAXFPS        7020 // Combo: independent mirror max FPS (parity/120/60/30)
#define IDC_MW_DISP_HUD_DISABLE   7021 // Checkbox: hide HUD on mirrors (linked to System tab)
