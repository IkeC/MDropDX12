...
void VisualWindow::DoBuildControls() {
  ...
  {
    HWND hTexBits = CreateWindowExW(0, L"COMBOBOX", NULL,
      WS_CHILD | WS_VISIBLE | CBS_DROPDOWNLIST | WS_VSCROLL,
      x + lw + 4, y, 120, lineH * 6, hw,
      (HMENU)(INT_PTR)IDC_MW_TEX_BITS, GetModuleHandle(NULL), NULL);
    if (hTexBits && hFont) SendMessage(hTexBits, WM_SETFONT, (WPARAM)hFont, TRUE);
  ...
  {
    HWND hFpsCap = CreateWindowExW(0, L"COMBOBOX", NULL,
      WS_CHILD | WS_VISIBLE | CBS_DROPDOWNLIST | WS_VSCROLL,
      x + lw + 4, y, 120, lineH * 8, hw,
      (HMENU)(INT_PTR)IDC_MW_FPS_CAP, GetModuleHandle(NULL), NULL);
    if (hFpsCap && hFont) SendMessage(hFpsCap, WM_SETFONT, (WPARAM)hFont, TRUE);
